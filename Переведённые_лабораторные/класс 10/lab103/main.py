...
class LabSurfaceTensionApp(QWidget):
	def __init__(self):
		super().__init__()
		self.setWindowTitle("Беттик чокулук (беттик) — σ = m·g / (π·d)")
		...
		btn_simulate = QPushButton("Өсүшүндү жана ажырашуу сыналтуу")
		...
		btn_check = QPushButton("σ текшер")
...
# --- оригинал файла lab103/main.py кончается ---
